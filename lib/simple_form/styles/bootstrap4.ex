defmodule SimpleForm.Styles.Bootstrap4 do
  ...
  iex> checkbox(SimpleForm.Factory.build(:form_input, style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> checkbox(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: "someValue"}}, input_attrs: [class: "A"], style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> date_select(SimpleForm.Factory.build(:form_input, style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> date_select(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: "someValue"}}, input_attrs: [class: "A"], style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> datetime_select(SimpleForm.Factory.build(:form_input, style_module: Bootstrap4)) |> safe_to_string()
  ~s(<div class="form-group"><label class="control-label" for="name">Name</label><input class="form-control" id="name" name="name" type="text"></div>)

  You can overwrite the input attributes

  iex> datetime_select(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: "someValue"}}, input_attrs: [class: "A"], style_module: Bootstrap4)) |> safe_to_string()
  ~s(<div class="form-group"><label class="control-label" for="name">Name</label><input class="A" id="name" name="name" type="text" value="someValue"></div>)
  ...
  iex> number_input(SimpleForm.Factory.build(:form_input, style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> number_input(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: "someValue"}}, input_attrs: [class: "A"], style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> text_input(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: nil}}, style_module: Bootstrap4)) |> safe_to_string()
  ~s(<div class="form-group"><label class="control-label" for="name">Name</label><input class="form-control" id="name" name="name" type="text"></div>)

  iex> text_input(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: "someValue"}}, style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> text_input(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: "someValue"}}, input_attrs: [class: "A"], style_module: Bootstrap4)) |> safe_to_string()
  ~s(<div class="form-group"><label class="control-label" for="name">Name</label><input class="A" id="name" name="name" type="text" value="someValue"></div>)
  ...
  iex> email_input(SimpleForm.Factory.build(:form_input, style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> email_input(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: "someValue"}}, input_attrs: [class: "A"], style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> textarea(SimpleForm.Factory.build(:form_input, style_module: Bootstrap4)) |> safe_to_string()
  ~s(<div class="form-group"><label class="control-label" for="name">Name</label><textarea class="form-control" id="name" name="name">\n</textarea></div>)

  You can overwrite the input attributes

  iex> textarea(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: "someValue"}}, input_attrs: [class: "A",rows: 9], style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> plain(SimpleForm.Factory.build(:form_input, style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> plain(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: "someValue"}}, input_attrs: [class: "A"], style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> select(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: ""}}, collection: ["A","B","C"], style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> select(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: ""}}, collection: [{"A", "1"},{"B", "2"},{"C", "3"}], style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex> select(SimpleForm.Factory.build(:form_input, form: %Phoenix.HTML.Form{data: %{name: ""}}, collection: [{"A", "1"},{"B", "2"},{"C", "3"}], input_attrs: [class: "A"], style_module: Bootstrap4)) |> safe_to_string()
  ...
  iex>wrapper(SimpleForm.Factory.build(:form_input, label: "Label", style_module: Bootstrap4), do: "#Inner Block#") |> safe_to_string()
  ...
  iex> input_group(SimpleForm.Factory.build(:form_input, style_module: Bootstrap4), ~s(<div>Inner Block</div>))
  ~s(<div>Inner Block</div>)


  With `:prepend_text` you're able to prepend some text for the input group.

  iex> input_group(SimpleForm.Factory.build(:form_input, wrapper_attrs: [prepend_text: "Some Test"], style_module: Bootstrap4), "#Inner Block#") |> safe_to_string()
  ...
  iex> input_group(SimpleForm.Factory.build(:form_input, style_module: Bootstrap4, wrapper_attrs: [append_text: "Some Test"]), "#Inner Block#") |> safe_to_string()
  ...
  iex> label(SimpleForm.Factory.build(:form_input, style_module: Bootstrap4, required: true)) |> safe_to_string()
  ~s(<label class="control-label required" for="name">Name</label>)

  iex> label(SimpleForm.Factory.build(:form_input, style_module: Bootstrap4, required: true, label_attrs: [class: "A", disabled: "true"])) |> safe_to_string()
  ~s(<label class="A" disabled="true" for="name">Name</label>)

  iex> label(SimpleForm.Factory.build(:form_input)) |> safe_to_string()
  ~s(<label class="control-label" for="name">Name</label>)

  iex> label(SimpleForm.Factory.build(:form_input, label_attrs: [class: "A", disabled: "true"])) |> safe_to_string()
  ~s(<label class="A" disabled="true" for="name">Name</label>)
  ...
  iex> hint(SimpleForm.Factory.build(:form_input, hint: nil)) |> safe_to_string()
  ""

  iex> hint(SimpleForm.Factory.build(:form_input, hint: "This is a hint")) |> safe_to_string()
  ...
  iex> error_tag(SimpleForm.Factory.build(:form_input, errors_translated: [])) |> safe_to_string()
  ""

  iex> error_tag(SimpleForm.Factory.build(:form_input, errors_translated: ["Some Error"])) |> safe_to_string()
